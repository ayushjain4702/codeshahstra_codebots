...
import userSix from "../images/user/user-k.png";
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Cafe Coffee Day</p>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                Café Coffee Day is a popular coffeehouse chain in India, founded
                in 1996 by V. G. Siddhartha. The company operates over 1500
                cafes in India and a few international locations. The cafes
                offer a variety of hot and cold beverages, sandwiches, desserts,
                and other snacks. Café Coffee Day is known for its warm and
                welcoming ambiance, and it is a popular hangout spot for young
                people in India. The cafes often host live music events and
                other activities to attract customers. The chain has also
                introduced a mobile app and a loyalty program to engage with its
                customers and enhance their experience. In recent years, Café
                Coffee Day has faced financial difficulties due to high debt and
                other factors, and its founder passed away in 2019. However, the
                company continues to operate its cafes and expand its reach in
                India and abroad.
              </p>
            </div>
